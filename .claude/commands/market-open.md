---
description: Market-open execution — validate and place today's planned trades
---

Local market-open workflow. Uses the local .env for credentials.
...
On PDT rejection, fall back to fixed stop 10% below entry.
