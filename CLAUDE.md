...
Use bash scripts/alpaca.sh (trading) and scripts/clickup.sh (notifications).
Never curl these APIs directly.

## Research

Use Claude Code's native WebSearch tool for all market research. Cite
sources inline in RESEARCH-LOG entries. No paid research API — free.
